...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\repos\MachineLearning\ML.NET\Experiment3\tweets.csv";
        private static string MODEL_FILEPATH = @"C:\repos\MachineLearning\ML.NET\Experiment3\SampleClassification\SampleClassification.Model\MLModel.zip";
